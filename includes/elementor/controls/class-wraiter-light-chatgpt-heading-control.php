...
if ( ! class_exists( 'Wraiter_Light_ChatGPT_Heading_Control' ) ) :
	/**
	 *
	 * Headingcontrol for AI content generation.
	 * This class defines the Heading control for generating AI-generated content in Elementor.
	 * It adds several controls to the Heading widget, allowing users to specify the prompt, keywords,
	 ...
	 * @subpackage Wraiter Light/includes
	 */
	class Wraiter_Light_ChatGPT_Heading_Control {

		/**
		 * Constructor.
		 *
		 * Add action for Elementor Heading widget.
		 */
		public function __construct() {
			add_action( 'elementor/element/heading/section_title/before_section_end', array( $this, 'ai_content_generation_controls' ), 20, 2 );
		}

		/**
		 * AI Heading controls.
		 *
		 * Add controls to Elementor Heading widget.
		 *
		...
		public function ai_content_generation_controls( $widget, $section_id ) {
			$widget->add_control(
				...
				array(
					'label'     => esc_html__( 'Wraiter Light AI Heading Generation', 'wraiter-light' ),
			...
			$widget->add_control(
				...
				array(
					...
					'label'       => esc_html__( 'Type for Content Generation', 'wraiter-light' ),
					'label_block' => true,
					'rows'        => 2,
			...
			$widget->add_control(
				...
				array(
					...
					'event'       => 'wraiterlight:heading:generate',
				)
			);
		}
	...
	new Wraiter_Light_ChatGPT_Heading_Control();
endif;
