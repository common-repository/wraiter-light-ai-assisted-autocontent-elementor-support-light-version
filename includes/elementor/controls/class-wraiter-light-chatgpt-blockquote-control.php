...
if ( ! class_exists( 'Wraiter_Light_ChatGPT_Blockquote_Control' ) ) :
	/**
	 *
	 * Blockquotecontrol for AI content generation.
	 ...
	 * @subpackage Wraiter Light/includes
	 */
	class Wraiter_Light_ChatGPT_Blockquote_Control {
		...
		public function __construct() {
			add_action( 'elementor/element/blockquote/section_blockquote_content/before_section_end', array( $this, 'ai_content_generation_controls' ), 20, 2 );
		}
		...
		public function ai_content_generation_controls( $widget, $section_id ) {
			$widget->add_control(
				...
				array(
					'label'     => esc_html__( 'Wraiter Light AI Blockquote Content Generation', 'wraiter-light' ),
			...
			$widget->add_control(
				...
				array(
					...
					'label'       => esc_html__( 'Prompt Text for Blockquote Content Generation', 'wraiter-light' ),
					'label_block' => true,
					'rows'        => 2,
			...
			$widget->add_control(
				...
				array(
					...
					'event'       => 'wraiterlight:blockquote:request',
				)
			);
		}
	...
	new Wraiter_Light_ChatGPT_Blockquote_Control();
endif;
