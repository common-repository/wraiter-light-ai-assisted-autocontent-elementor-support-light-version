...
if ( ! class_exists( 'Wraiter_Light_ChatGPT_Text_Editor_Control' ) ) :
	/**
	 *
	 ...
	 * @subpackage Wraiter Light/includes
	 */
	class Wraiter_Light_ChatGPT_Text_Editor_Control {
		...
		public function __construct() {
			add_action( 'elementor/element/text-editor/section_editor/before_section_end', array( $this, 'ai_content_generation_controls' ), 20, 2 );
		}
		...
		public function ai_content_generation_controls( $widget, $section_id ) {
			$widget->add_control(
				...
				array(
					'label'     => esc_html__( 'WrAIter Light AI Text Content Generation', 'wraiter-light' ),
			...
			$widget->add_control(
				...
				array(
					...
					'label'       => esc_html__( 'Prompt Text for Content Generation', 'wraiter-light' ),
					'label_block' => true,
					'rows'        => 2,
			...
			$widget->add_control(
				...
				array(
					...
					'event'       => 'wraiterlight:content:generate',
				)
			);
		}
	...
	new Wraiter_Light_ChatGPT_Text_Editor_Control();
endif;
